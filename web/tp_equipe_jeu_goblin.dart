...
class Goblin {   //créer la classe goblin
  int x = 220;
  int y = 117;
  int width = 60;
  int height = 63;
...
gameEnd(){  //termine le jeu dans un intervale de 10 secondes et affiche un message
  var message = {};
  new Timer.periodic(const Duration(seconds: 5), (t) => window.alert('${message}, Vous avez attrapé: ${goblinsCaught} Goblins!!'));
  if ((goblinsCaught) <= 10) {
